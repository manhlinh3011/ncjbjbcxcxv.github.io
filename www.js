...
CGV.controller('tablePhim', ['$scope', 
    function($scope){
        ...
        $scope.listMovie.push('Captain Marvel', './assets/img/240_10_27.jpg', 'rating-P');
        $scope.listMovie.push('Chị trợ lý của anh', './assets/img/240_10_47.jpg', 'rating-P');
        $scope.listMovie.push('Hai Phượng', './assets/img/240_12_3.jpg', 'rating-P');
        $scope.listMovie.push('Mật vụ thanh trừng', './assets/img/240_14_19.jpg', 'rating-P');
        $scope.listMovie.push('Công viên kỳ diệu', './assets/img/240_12_6.jpg', 'rating-P');
        $scope.listMovie.push('Yêu nhầm bạn thân', './assets/img/240_10_27.jpg', 'rating-P');
        $scope.listMovie.push('Hạnh phúc của mẹ', './assets/img/240_10_27.jpg', 'rating-P');
